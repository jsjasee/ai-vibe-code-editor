    ...
    <div className=" z-20 flex flex-col items-center justify-start min-h-screen py-2 mt-10">
      <div className="flex flex-col justify-center items-center my-5">
        <Image
          ...
          width={799}
          height={756}
          className="h-auto w-125 max-w-full"
          loading="eager"
        />
      ...
      <Link href={"/dashboard"}>
        {/* is this how we do customisations? add a brand to the variant section of the button */}
...
// this is the main page of our application, the root path, "/"
