...
const AddNewButton = () => {
  ...
  const handleSubmit = async (data: {
    ...
    setIsModalOpen(false); // close our template model window
    router.push(`/playground/${res?.id}`); // redirect the user to the playground page aka IDE
  };

  return (
    <>
      <div
        onClick={() => setIsModalOpen(true)} // a modal is like a popup
