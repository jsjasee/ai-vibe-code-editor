...
export default function ProjectTable({
  ...
  // first two methods for opening dialog, last 2 methods aka the async await is for performing server action
  ...
  const copyProjectUrl = (projectId: string) => {
    //    Write your logic here
    const url = `${window.location.origin}/playground/${projectId}`; // window.location.origin copies the domain like example.com?
