...
// path-to-json utility converts the code that is stored in that file path into JSON format so that it can be easily stored. more efficient.

/**
 * Represents a file in the template structure, for eg. if we have index.html angular boilerplate code file, the file name is index, extension is .html, and the content is whatever is inside index.html
 */
