...
import ReactMarkdown from "react-markdown"; // ollama give us the output in markdown format, need to parse it so that the chat looks professional and nice
...
interface ChatMessage {
  ...
  id: string;
  timestamp: Date;
  type?: "chat" | "code_review" | "suggestion" | "error_fix" | "optimization"; // for ui purpose only
  tokens?: number;
  model?: string;
}
...
export const AIChatSidePanel: React.FC<AIChatSidePanelProps> = ({
  ...
  const [chatMode, setChatMode] = useState<
    "chat" | "review" | "fix" | "optimize" // also ui purpose ag
  >("chat");
